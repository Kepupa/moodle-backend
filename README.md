...
братиш, постгрес не воспринимает запятые, и почему у тебя в id 2.7???? Ты походу напортачил с импортом таблиц, у тебя там нигде не должно быть запятых. Он же тебе говорит что ожидает число а ты ему 2.7
