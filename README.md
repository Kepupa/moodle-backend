...
вспомни че я тебе в тг писал пхаахп, ну ваще было бы классно проверить лол. Ну и в зависмости от этого написать код, задание и пример интерфейса по идеи точно такое же, на перерыве сверим, но накидай лучше ща че нить
