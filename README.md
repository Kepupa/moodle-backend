...
Использовать шрифт Candara.
В качестве основного фона используется белый цвет, дополнительного
фона
используется
цвет
#D2DFFF.
...
акцентирования
внимания
пользователя на целевом действии интерфейса используйте цвет #355CBD.
Основной фонДополнительный фонАкцентирование
внимания
...
С шрифтами уже четворока стопудова, мб пятерочка, блять ебать там у ксюши пизда
